...
public class ExtraItemList {
    ...
    @SerializedName("order_extra_item_kot_yn")
    @Expose
    private String order_extra_item_kot_yn;
    ...
    public String getOrder_extra_item_kot_yn() {
        return order_extra_item_kot_yn;
    }

    public void setOrder_extra_item_kot_yn(String order_extra_item_kot_yn) {
        this.order_extra_item_kot_yn = order_extra_item_kot_yn;
    }
